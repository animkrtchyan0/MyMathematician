...
public class QuizDeriv1 extends AppCompatActivity {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestionIndex < questionList.size()) {
                    ...
                    Intent intent = new Intent(QuizDeriv1.this, ResultsActivity.class);
    ...
    private void loadQuestions() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM questionsDeriv1", null);
