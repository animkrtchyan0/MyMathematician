...
public class QuizFunc2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_func2);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestionIndex < questionList.size()) {
                    ...
                    Intent intent = new Intent(QuizFunc2.this, ResultsActivity.class);
    ...
    private void loadQuestions() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM questionsFunc2", null);
