...
public class QuizArithm2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_arithm2);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestionIndex < questionList.size()) {
                    ...
                    Intent intent = new Intent(QuizArithm2.this, ResultsActivity.class);
    ...
    private void loadQuestions() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM questionsArithm2", null);
        if (cursor.moveToFirst()) {
            do {
                ...
                @SuppressLint("Range") int correctAnswer = cursor.getInt(cursor.getColumnIndex("correct_answer"));
