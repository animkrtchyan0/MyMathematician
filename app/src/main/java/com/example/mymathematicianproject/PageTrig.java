...
public class PageTrig extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_trig);
    ...
    private void loadQuestion() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM quizTrig ORDER BY RANDOM() LIMIT 1",null);
