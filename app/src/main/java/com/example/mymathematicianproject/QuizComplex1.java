...
public class QuizComplex1 extends AppCompatActivity {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestionIndex < questionList.size()) {
                    ...
                    Intent intent = new Intent(QuizComplex1.this, ResultsActivity.class);
    ...
    private void loadQuestions() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM questionsComplex1", null);
